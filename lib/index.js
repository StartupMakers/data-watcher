  ...
  _createClass(ExternalListWatcher, [{
    ...
    value: function start() {
      ...
      var _options = this.options,
          skipFirstRequest = _options.skipFirstRequest,
    ...
    value: function setNextURL() {
      ...
      var _state = this.state,
          targetURLIndex = _state.targetURLIndex,
          isAllFailed = _state.isAllFailed,
          targetURL = _state.targetURL;
    ...
    value: function handleSuccess(response) {
      var _options2 = this.options,
          ...
          refreshInterval = _options2.refreshInterval;
    ...
    value: function handleFailure(error) {
      ...
      var _options3 = this.options,
          onFailure = _options3.onFailure,
          defaultResult = _options3.defaultResult,
          failureTimeout = _options3.failureTimeout;
    ...
    value: function _submitRequest() {
      var _options4 = this.options,
          fetchOptions = _options4.fetchOptions,
          fetch = _options4.fetch;
